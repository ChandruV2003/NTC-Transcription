...
def create_app(test_config: dict | None = None, *, store: TranscriptionStore | None = None) -> Flask:
    ...
    app.config.update(
        ...
        NTC_TRANSCRIPTION_CONNECT_TIMEOUT_SECONDS=float(os.getenv("NTC_TRANSCRIPTION_CONNECT_TIMEOUT_SECONDS", "3.0")),
        NTC_TRANSCRIPTION_LIVE_TIMEOUT_SECONDS=float(os.getenv("NTC_TRANSCRIPTION_LIVE_TIMEOUT_SECONDS", "30.0")),
        NTC_TRANSCRIPTION_BATCH_TIMEOUT_SECONDS=float(os.getenv("NTC_TRANSCRIPTION_BATCH_TIMEOUT_SECONDS", "300.0")),
